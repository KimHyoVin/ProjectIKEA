...
CREATE TABLE MEMBER (
    ...
    MEMBER_EMAIL            VARCHAR2(40)    UNIQUE NOT NULL,  -- ID 역할을  EMAIL이 대신함
    MEMBER_PW               VARCHAR2(200)   NOT NULL,
    MEMBER_NAME             VARCHAR2(20)    NOT NULL,
    MEMBER_BIRTH            DATE            NOT NULL,
    MEMBER_PNUM             VARCHAR2(20)    NOT NULL,   -- 전화번호
    MEMBER_ZIPCODE          VARCHAR2(20)    NOT NULL,   -- 우편번호
    MEMBER_ADDRESS          VARCHAR2(200)   NOT NULL,   -- 주소(API이용시 자동으로 담긴다)
    MEMBER_DETAILSADDRESS   VARCHAR2(100) ,  -- 상세주소와 참고사항은 여기에 담는다
