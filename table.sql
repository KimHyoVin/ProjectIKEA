...
CREATE TABLE PRODUCT (
    ...
    PRODUCT_WIDTH           NUMBER, -- 상품 너비(cm) (-> 0이라면 상세페이지에서 출력하지 말자!)
...
CREATE TABLE MEMBER (
    ...
    MEMBER_EMAIL            VARCHAR2(40)    UNIQUE NOT NULL,  -- EMAIL. ID를 대신함
    ...
    MEMBER_ISDELETED        CHAR(1)         DEFAULT 'N' CHECK(MEMBER_ISDELETED IN ('Y', 'N'))    -- 'Y' -> 삭제됨(DB에는 존재함)
);

CREATE TABLE PRODUCT_CATEGORY (
    CATEGORY_NAME       VARCHAR2(30)    UNIQUE NOT NULL,
    CATEGORY_REF        VARCHAR2(30)
);
...
CREATE TABLE PRODUCT_IMAGE (
    ...
    IMAGE_FILENAME          VARCHAR2(100)    NOT NULL,   -- 이미지 파일명 (날짜 + UUID난수)
...
INSERT INTO MEMBER( MEMBER_EMAIL, MEMBER_PW, MEMBER_NAME, MEMBER_BIRTH,  MEMBER_PNUM, MEMBER_ZIPCODE, MEMBER_ADDRESS, MEMBER_DETAILSADDRESS, MEMBER_GENDER, MEMBER_ISDELETED) VALUES ( 'dummy1@gmail.com', 'dummypw1', '김더미', '1990-03-09',  '01012345678', '48051', '남천로', 'A아파트 101-1101', 'M','N');
INSERT INTO MEMBER( MEMBER_EMAIL, MEMBER_PW, MEMBER_NAME, MEMBER_BIRTH,  MEMBER_PNUM, MEMBER_ZIPCODE, MEMBER_ADDRESS,  MEMBER_DETAILSADDRESS, MEMBER_GENDER, MEMBER_ISDELETED) VALUES ( 'dummy2@gmail.com', 'dummypw2', '박더미', '1993-01-22',  '01087654321', '56491','순환로', 'B아파트 201-102', 'F', 'N');
INSERT INTO MEMBER( MEMBER_EMAIL, MEMBER_PW, MEMBER_NAME, MEMBER_BIRTH,  MEMBER_PNUM, MEMBER_ZIPCODE, MEMBER_ADDRESS, MEMBER_DETAILSADDRESS, MEMBER_GENDER, MEMBER_ISDELETED) VALUES ( 'dummy3@gmail.com', 'dummypw3', '이더미', '1995-06-19',  '01044434443', '1710021', '한적로','C아파트 501-803', 'X', 'N');
...
-- 카테고리
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME) VALUES ('categ1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-1', 'categ1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-2', 'categ1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-1-1', 'categ1-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-1-2', 'categ1-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-1-3', 'categ1-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-2-1', 'categ1-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-2-2', 'categ1-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ1-2-3', 'categ1-2');

INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME) VALUES ('categ2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-1', 'categ2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-2', 'categ2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-1-1', 'categ2-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-1-2', 'categ2-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-1-3', 'categ2-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-2-1', 'categ2-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-2-2', 'categ2-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ2-2-3', 'categ2-2');

INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME) VALUES ('categ3');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-1', 'categ3');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-2', 'categ3');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-1-1', 'categ3-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-1-2', 'categ3-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-1-3', 'categ3-1');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-2-1', 'categ3-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-2-2', 'categ3-2');
INSERT INTO PRODUCT_CATEGORY (CATEGORY_NAME, CATEGORY_REF) VALUES ('categ3-2-3', 'categ3-2');
